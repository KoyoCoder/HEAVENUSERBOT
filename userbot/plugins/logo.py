...
#
# This file is a part of < https://github.com/VILLAIN-V01/HEAVENBOT/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/VILLAIN-V01/HEAVENBOT/blob/main/LICENSE/>.
"""
✘ Commands Available -
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        async for i in event.client.iter_messages(
            "@HeavenLogos", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
