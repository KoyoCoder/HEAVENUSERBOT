...
@heavenbot.on(admin_cmd(pattern="sin ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="cos ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="tan ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="cosec ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="sec ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="cot ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="square ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@heavenbot.on(admin_cmd(pattern="cube ?(.*)"))
@heavenbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
