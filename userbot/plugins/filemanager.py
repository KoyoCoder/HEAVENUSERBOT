...
async def _(event):
    ...
    OUTPUT = f"**Files in [Hêllẞø†](t.me/heavenbot_official) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your heavenbot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of heavenbot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your heavenbot server'
).add_command(
