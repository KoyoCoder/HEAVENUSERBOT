...
@bot.on(admin_cmd(pattern=r"heaveno$"))
@bot.on(sudo_cmd(pattern="heaveno$", allow_sudo=True))
async def bluedevilheaveno(heaveno):
    if heaveno.fwd_from:
        return
    await edit_or_reply(heaveno, K)
