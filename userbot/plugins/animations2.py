...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](VILLAIN-V01/HEAVENBOT)**",
        ...
        "__INFO:HeavenBot:Logged in as 557667062__",
        "__INFO:HeavenBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
