...
async def _(dyno):
    ...
    heaven_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": heaven_data})
        .json()
        .get("result")
        .get("key")
    )
    heaven_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{heaven_key}) && [RAW PAGE](https://nekobin.com/raw/{heaven_key}) ⚡"
